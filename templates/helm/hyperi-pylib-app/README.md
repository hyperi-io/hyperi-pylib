# hyperi-pylib App HELM Chart

Production-ready HELM chart for hyperi-pylib applications (API, Daemon, MCP).

## Features

- Support for all hyperi-pylib application types (API, Daemon, MCP)
...
```bash
helm install my-app ./templates/helm/hyperi-pylib-app \
  --set app.name=my-app \
  --set app.type=api \
...
```bash
helm install my-api ./templates/helm/hyperi-pylib-app \
  --set app.type=api \
...
```bash
helm install my-daemon ./templates/helm/hyperi-pylib-app \
  --set app.type=daemon \
...
```bash
helm install my-app ./templates/helm/hyperi-pylib-app -f values-prod.yaml
```
...
```bash
# Dry run
helm upgrade my-app ./templates/helm/hyperi-pylib-app --dry-run --debug

# Apply upgrade
helm upgrade my-app ./templates/helm/hyperi-pylib-app
