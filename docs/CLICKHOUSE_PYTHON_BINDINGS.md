...
This document outlines the approach for exposing hs-rustlib's ClickHouse client to Python via PyO3, enabling hyperi-pylib to leverage the Rust implementation's performance and type safety.
...
```python
# hyperi-pylib uses hs-rustlib-python as optional dependency
# pyproject.toml
