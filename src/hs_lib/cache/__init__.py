...
"""
hs-lib Cache Module - Disk-Backed Caching with Per-Source TTLs.
...
Quick Start:
    >>> from hs_lib.cache import configure_cache, cached, cache
    >>>
...
Dependencies:
    pip install hs-lib[cache]  # Installs cashews[diskcache]
"""
