"""
Example CLI applications using Typer with hs-pylib.
...
from hs_pylib.cli import Argument, Option, Typer
...
config_app = Typer(help="CLI with hs-pylib config integration")
...
def deploy(
    ...
    # Integration with hs_pylib.config
    try:
