"""
hs-pylib CLI utilities - Typer-based command-line interface framework.

This module provides CLI utilities and standards for hs-pylib applications.
...
Basic Usage:
    from hs_pylib.cli import Typer, Option, Argument
    from hs_pylib.cli.output import print_success, print_table
    from hs_pylib.cli.options import VERBOSE_OPTION
...
Modules:
    - hs_pylib.cli.output - Output formatting utilities
    - hs_pylib.cli.options - Reusable CLI options
    - hs_pylib.cli.version - Version handling
    - hs_pylib.cli.examples - Complete usage examples

Examples:
    See hs_pylib/cli/examples.py and docs/CLI-STANDARDS.md for complete examples.
"""
    ...
    class _TyperNotInstalled:
        ...
        def __init__(self, *args, **kwargs):
            raise ImportError(
                ...
                "Install with: pip install hs-pylib[cli]\n"
