"""
hs-pylib Database Utilities - Zero-Config Connection Builders
===============================================================
...
===========
    ...
    # Install
    pip install hs-pylib[database]

    # PostgreSQL (automatic ENV detection!)
    from hs_pylib import build_database_url
...
==============
    ...
    from hs_pylib.dbconn import get_database_config
