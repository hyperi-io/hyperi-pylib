...
Basic usage:
    ...
    # With OpenBao/Vault (requires: pip install hs-pylib[secrets-vault])
    from hs_pylib.secrets import SecretsManager, OpenBaoConfig
    ...
    # With AWS (requires: pip install hs-pylib[secrets-aws])
    from hs_pylib.secrets import SecretsManager, AWSConfig
...
Providers:
    ...
    - openbao: OpenBao/Vault (optional: hs-pylib[secrets-vault])
    - aws: AWS Secrets Manager (optional: hs-pylib[secrets-aws])
