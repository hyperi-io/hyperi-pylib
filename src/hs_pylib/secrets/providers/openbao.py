...
from ..exceptions import AuthenticationError, ProviderError, SecretNotFoundError
from ..types import OpenBaoConfig, SecretValue
    ...
    def __init__(self, config: OpenBaoConfig) -> None:
        ...
        if not HTTPX_AVAILABLE:
            ...
            raise ProviderNotAvailableError(
                "openbao", "httpx", "pip install httpx or pip install hs-pylib[secrets-vault]"
            )
