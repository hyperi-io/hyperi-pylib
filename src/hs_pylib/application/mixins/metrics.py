...
This mixin integrates with hs_pylib.metrics to provide automatic metrics
...
class MetricsMixin:
    ...
    tracking application-specific metrics. Uses existing hs_pylib.metrics module.
    ...
    def _setup_metrics(self) -> None:
        """
        Setup metrics collection using hs_pylib.metrics.
