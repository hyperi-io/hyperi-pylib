...
class CLIApplication(
    ...
    """
    Command-line application using Typer (mandatory hs-pylib standard).
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            typer_help = help or f"{name} - hs-pylib CLI Application"
            self.app = Typer(
                name=name,
                help=typer_help,
            ...
            raise ImportError(
                "Typer is required for CLI applications (hs-pylib mandatory standard). "
