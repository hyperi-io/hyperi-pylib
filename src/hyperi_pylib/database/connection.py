"""
hyperi-pylib Database Utilities - Zero-Config Connection Builders
===============================================================
...
===========
    ...
    # Install
    pip install hyperi-pylib[database]
...
==============
    ...
    from hyperi_pylib.dbconn import build_database_url

    postgres_url = build_database_url("postgresql")
    mysql_url = build_database_url("mysql")

    # Pattern 2: Get config dict
    from hyperi_pylib.dbconn import get_database_config
