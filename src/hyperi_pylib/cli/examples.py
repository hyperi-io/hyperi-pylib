"""
Example CLI applications using Typer with hyperi-pylib.
...
from hyperi_pylib.cli import Argument, Option, Typer
...
config_app = Typer(help="CLI with hyperi-pylib config integration")
...
def deploy(
    ...
    # Integration with hyperi_pylib.config
    try:
