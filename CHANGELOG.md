## [2.28.3](https://github.com/hyperi-io/hyperi-pylib/compare/v2.28.2...v2.28.3) (2026-05-27)


### Bug Fixes

* **cache:** replace /tmp examples + default secrets cache to ~/.cache/hyperi-ai ([746b84d](https://github.com/hyperi-io/hyperi-pylib/commit/746b84d15fee6b0e6bf1cfa25b75a4f372a8ba11))
* CEL IS NULL emit, resilience probe slot reservation, starlette CVE bump ([b607b0e](https://github.com/hyperi-io/hyperi-pylib/commit/b607b0eb5fd97d45d25153f3d9a23b444a0697a9))
* **chars:** replace non-ASCII typography in source + rewrite package description ([a0e622c](https://github.com/hyperi-io/hyperi-pylib/commit/a0e622c10cc3fc1fbb390b3d61fe510da24cc542))
* **config:** postgres fallback defaults to ~/.cache, never /tmp ([89f5ef5](https://github.com/hyperi-io/hyperi-pylib/commit/89f5ef54c87cad7d862190bea1b91fb22d435001))
* **config:** respect env > postgres priority in cascade ([645f5f8](https://github.com/hyperi-io/hyperi-pylib/commit/645f5f8cafea1ac07e0f6cfb3dbfccfa4bbed331))
* **database:** url-encode database name + query parameters ([c138137](https://github.com/hyperi-io/hyperi-pylib/commit/c13813710c7f30a43bbbfc9c3575efea605d0650))
* **deployment:** add AppProject generator ([ee88233](https://github.com/hyperi-io/hyperi-pylib/commit/ee88233689d32d1f871625824b6aafc76443ecc0))
* **deployment:** add contract artefacts e2e TEMPLATE ([5a738db](https://github.com/hyperi-io/hyperi-pylib/commit/5a738dbd3a4dab633fbabb9cc8f9eabc864c5544))
* **deployment:** add ContractIdentity v1 module ([752da51](https://github.com/hyperi-io/hyperi-pylib/commit/752da51337963a70036005335c9165f8d263d457))
* **deployment:** add test_support module for e2e probes and skip helper ([49375ee](https://github.com/hyperi-io/hyperi-pylib/commit/49375eea1d9de87166773641f7a5567c93a538d2))
* **deployment:** add waves module with sync-wave constants ([e6450f5](https://github.com/hyperi-io/hyperi-pylib/commit/e6450f57426640a04c577e777ebf4681a4e370ee))
* **deployment:** emit default ignoreDifferences + WAVE_APPS default sync_wave ([a08f8c0](https://github.com/hyperi-io/hyperi-pylib/commit/a08f8c0529164e2ed96993d1f4c665213f00b50d))
* **deployment:** Helm no-KEDA fallback + KEDA SASL wiring + ScalingPressure validation ([696de36](https://github.com/hyperi-io/hyperi-pylib/commit/696de3636312fcce67e116d5ec6b4164775224fc))
* **deployment:** test_support.skip() degrades gracefully when log unwritable ([9359970](https://github.com/hyperi-io/hyperi-pylib/commit/9359970595706458c2db0e8aa7ceb09f4fdf8650))
* **deployment:** wire ContractIdentity into 5 artefact generators ([207b50f](https://github.com/hyperi-io/hyperi-pylib/commit/207b50f81a5e84d2224df6bef38ae14bd85f9439))
* **deps:** drop diskcache from [cache] -- CVE-2025-69872 has no fix ([e441e30](https://github.com/hyperi-io/hyperi-pylib/commit/e441e30d4dde80b953eb8d4b6a538cfdb04c343e))
* **docs:** add subsystem docs in subdirs and retire monolithic top-level docs ([dd5e60b](https://github.com/hyperi-io/hyperi-pylib/commit/dd5e60b1c6910979c38d19ecb7884df3de856f07))
* **docs:** correct schema kwargs + KEDA import path + database extras + extras-flags ([5db31bf](https://github.com/hyperi-io/hyperi-pylib/commit/5db31bfef8457bdd3eab6640c6727e7b3d8fa5b3))
* **docs:** remove aspirational/deprecated docs and move non-user docs ([eed25cc](https://github.com/hyperi-io/hyperi-pylib/commit/eed25cc8e68369ae7df4769cc1d3dfc632493648))
* **docs:** rewrite top-level entry + add ARCHITECTURE / INTEGRATION / AUTO-WIRING / EXTRAS-FLAGS ([97c4450](https://github.com/hyperi-io/hyperi-pylib/commit/97c445053496dbc4fb13eaf4f0a234b83a68528c))
* **docs:** tighten docstrings ([56b57ae](https://github.com/hyperi-io/hyperi-pylib/commit/56b57aeecaa8085f3b0d8c64406e097ee99b509e))
* **docs:** tighten docstrings + test module headers per style guide ([2a0e1dc](https://github.com/hyperi-io/hyperi-pylib/commit/2a0e1dc3876ca0126650b6b0818313c1a71c11fc))
* **harness,tests:** smart_run enforces timeouts on silent child + real Kafka BufferError test ([6af0b5e](https://github.com/hyperi-io/hyperi-pylib/commit/6af0b5ec356e205fa4b662ebc59b8ff3e86fef61))
* **harness:** repair smart_run + smart_run_function broken API surface ([805abed](https://github.com/hyperi-io/hyperi-pylib/commit/805abedd0eea552d3b7b8e46d03c2ccf59e5a831))
* **health:** async probes with per-check timeout + threading.Lock on registration ([2863880](https://github.com/hyperi-io/hyperi-pylib/commit/28638808a7c0c5e5b3b42c49fc7072e3b0fe3751))
* **http,resilience:** traceparent + Idempotency-Key passthrough + composition test ([763e446](https://github.com/hyperi-io/hyperi-pylib/commit/763e446acf577f182690657743e03380987ec5fa))
* **kafka:** async producer surfaces delivery reports + retries on BufferError ([4bf197e](https://github.com/hyperi-io/hyperi-pylib/commit/4bf197eeed024666374e428be93d05d587800a0f))
* **kafka:** incremental_alter_configs + run_blocking + partition math + doc API ([95ccb64](https://github.com/hyperi-io/hyperi-pylib/commit/95ccb64b26ef6a69c916ae3ea4551cd5b3985084))
* **license:** derive default-trust from load source, not from tampered payload ([d4b1521](https://github.com/hyperi-io/hyperi-pylib/commit/d4b1521c0a7be3247599147accd08dbb2eb1df45))
* **logger,config:** scrub bind context + exception chain; mask DSN in raised errors ([fa8f918](https://github.com/hyperi-io/hyperi-pylib/commit/fa8f9188074dd196b1965f6a5863b6e723dd8220))
* **logger,kafka:** pre-compile sensitive regexes + mask creds in Kafka repr ([919c39d](https://github.com/hyperi-io/hyperi-pylib/commit/919c39d991c0d1f4469ea57f11643d3c9c5415ec))
* **logger:** key-mask record.extra regardless of scrubber path ([523e7ff](https://github.com/hyperi-io/hyperi-pylib/commit/523e7ff226ba69a4870040e783e0210fbdb03c4c))
* **logger:** wire LOG_FORMAT env var + explicit utf-8 file sink ([5020923](https://github.com/hyperi-io/hyperi-pylib/commit/5020923715c0e27079c8495ea907bba369c7a076))
* **misc:** codex review tail -- invalidate_source, diskcache, OTel default, docs, encoding, PG type guards ([6b7be31](https://github.com/hyperi-io/hyperi-pylib/commit/6b7be310a52679cf6c264fb8b992913d3580faa8))
* **quality:** ruff format after review-pass edits ([585091b](https://github.com/hyperi-io/hyperi-pylib/commit/585091b1068be618b8af16fd86a67caf97b2a7d6))
* **quality:** ruff format pass on new test files ([0f97077](https://github.com/hyperi-io/hyperi-pylib/commit/0f970777173520b597105190c9eb92c506821770))
* **quality:** ruff lint + format pass ([23440fd](https://github.com/hyperi-io/hyperi-pylib/commit/23440fde01cf5b95c745a2f6864bfaf65c371aa8))
* **resilience,metrics:** probe ctx manager + bounded cardinality tracker ([a0f0a6a](https://github.com/hyperi-io/hyperi-pylib/commit/a0f0a6aac781cd12753ce82e088510272eb08d47)), closes [hi#cardinality](https://github.com/hi/issues/cardinality)
* **rule4:** add explicit utf-8 encoding to all subprocess + open + write_text sites ([ff7ae36](https://github.com/hyperi-io/hyperi-pylib/commit/ff7ae36509bd044ba3f6b57a7f8ce99a5c3e1252))
* **runtime:** guard os.getuid for Windows + refresh stale docstrings ([7edd15e](https://github.com/hyperi-io/hyperi-pylib/commit/7edd15ed8612a0fe87e8a6c3590b8b46ecf1aaee))
* **secrets/cache:** atomic write with unique tempfile + fsync + 0o600 perms ([9852453](https://github.com/hyperi-io/hyperi-pylib/commit/9852453420c4e33e0846e5cf048de3b40fccd1d5)), closes [hi#entropy](https://github.com/hi/issues/entropy) [hi#entropy](https://github.com/hi/issues/entropy)
* **secrets:** instance-scoped memory cache + structured cache key ([7e81ce4](https://github.com/hyperi-io/hyperi-pylib/commit/7e81ce42e4f9f42f02f80397965c9591fcc7d7fc))
* **secrets:** redact credentials in provider config repr ([dcd6c4e](https://github.com/hyperi-io/hyperi-pylib/commit/dcd6c4e6d3aecad9415788a08ee2162142e81dc4))
* **secrets:** vault httpx pin + VAULT alias + PostgresCache table_name + async run_blocking ([5923454](https://github.com/hyperi-io/hyperi-pylib/commit/5923454d69d05e97a5102edc56d5c923449c35a6))
* **security:** redact tyrell POC creds in plan doc; tests use fake_secrets helper ([db4ffdf](https://github.com/hyperi-io/hyperi-pylib/commit/db4ffdf920bfd4f2872876e2962556e0921a4712))
* **tests:** json-extra-leak uses direct loguru sink, not sys.stderr swap ([84bc389](https://github.com/hyperi-io/hyperi-pylib/commit/84bc389d33de7b269e4f2afb18e50e200a1bcf7a))
* **tests:** scope stamina.set_testing(True) to its own module via fixture ([cb8ad4e](https://github.com/hyperi-io/hyperi-pylib/commit/cb8ad4e371a9ad7feef82c93143a6f21f7326c3c))
