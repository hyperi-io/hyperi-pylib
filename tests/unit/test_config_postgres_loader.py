...
class TestPostgresConfigLoaderInit:
    ...
    def test_init_with_no_args_reads_env(self):
        ...
        with patch.dict(
            os.environ,
            {
                "HYPERI_CONFIG_DSN": "postgresql://user:pass@host/db",
                "HYPERI_CONFIG_TABLE": "my_config",
                "HYPERI_CONFIG_NAMESPACE": "my-app",
                "HYPERI_CONFIG_CACHE_TTL": "120",
            },
        ):
    ...
    def test_init_without_dsn_is_disabled(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            # Remove HYPERI_CONFIG_DSN if it exists
...
class TestPostgresConfigLoaderConnectionResilience:
    ...
    def test_init_connection_timeout_from_env(self):
        ...
        with patch.dict(
            os.environ,
            {
                "HYPERI_CONFIG_DSN": "postgresql://x@y/z",
                "HYPERI_CONFIG_CONNECT_TIMEOUT": "15",
            },
        ):
            loader = PostgresConfigLoader()
    ...
    def test_init_query_timeout_from_env(self):
        ...
        with patch.dict(
            ...
            {
                "HYPERI_CONFIG_DSN": "postgresql://x@y/z",
                "HYPERI_CONFIG_QUERY_TIMEOUT": "30",
            },
        ):
            loader = PostgresConfigLoader()
    ...
    def test_init_retry_attempts_from_env(self):
        ...
        with patch.dict(
            ...
            {
                "HYPERI_CONFIG_DSN": "postgresql://x@y/z",
                "HYPERI_CONFIG_RETRY_ATTEMPTS": "5",
            },
        ):
            loader = PostgresConfigLoader()
    ...
    def test_init_retry_delay_from_env(self):
        ...
        with patch.dict(
            ...
            {
                "HYPERI_CONFIG_DSN": "postgresql://x@y/z",
                "HYPERI_CONFIG_RETRY_DELAY_MS": "2000",
            },
        ):
            loader = PostgresConfigLoader()
...
class TestPostgresConfigLoaderFallbackFile:
    ...
    def test_init_fallback_file_from_env(self):
        ...
        with patch.dict(
            ...
            {
                "HYPERI_CONFIG_DSN": "postgresql://x@y/z",
                "HYPERI_CONFIG_FALLBACK_FILE": "/custom/path/fallback.yaml",
            },
        ):
            loader = PostgresConfigLoader()
    ...
    def test_init_fallback_mode_from_env(self):
        ...
        with patch.dict(
            ...
            {
                "HYPERI_CONFIG_DSN": "postgresql://x@y/z",
                "HYPERI_CONFIG_FALLBACK_MODE": "merge",
            },
        ):
            loader = PostgresConfigLoader()
