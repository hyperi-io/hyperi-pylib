...
# Purpose:   Unit tests for hyperi_pylib.kafka module
# Language:  Python
#
# License:   FSL-1.1-ALv2
# Copyright: (c) 2026 HYPERI PTY LIMITED

"""Unit tests for hyperi_pylib.kafka module.
...
class TestDefaults:
    ...
    def test_producer_defaults_has_acks_all(self):
        ...
        from hyperi_pylib.kafka.config import PRODUCER_DEFAULTS
    ...
    def test_consumer_defaults_has_earliest_offset(self):
        ...
        from hyperi_pylib.kafka.config import CONSUMER_DEFAULTS
    ...
    def test_admin_defaults_exist(self):
        ...
        from hyperi_pylib.kafka.config import ADMIN_DEFAULTS
...
class TestConfigMerge:
    ...
    def test_merge_config_applies_defaults(self):
        ...
        from hyperi_pylib.kafka.config import PRODUCER_DEFAULTS, merge_config
...
class TestConfigFromEnv:
    ...
    def test_config_from_env_reads_bootstrap_servers(self, monkeypatch):
        ...
        from hyperi_pylib.kafka.config import config_from_env
...
class TestMessage:
    ...
    def test_message_dataclass_fields(self):
        ...
        from hyperi_pylib.kafka.types import Message
...
class TestTopicTypes:
    ...
    def test_topic_info_dataclass(self):
        ...
        from hyperi_pylib.kafka.types import TopicInfo
    ...
    def test_partition_info_dataclass(self):
        ...
        from hyperi_pylib.kafka.types import PartitionInfo
    ...
    def test_topic_metadata_dataclass(self):
        ...
        from hyperi_pylib.kafka.types import PartitionInfo, TopicMetadata
    ...
    def test_consumer_group_info_dataclass(self):
        ...
        from hyperi_pylib.kafka.types import ConsumerGroupInfo
...
def mock_consumer_for_watermarks():
    ...
    with patch("hyperi_pylib.kafka.client.Consumer") as mock:
        yield mock
...
class TestKafkaClientDescribeTopic:
    ...
    def test_describe_topic_returns_metadata(self, mock_admin_client, mock_consumer_for_watermarks):
        ...
        from hyperi_pylib.kafka.client import KafkaClient
        from hyperi_pylib.kafka.types import TopicMetadata
    ...
    def test_describe_topic_not_found_raises(self, mock_admin_client):
        ...
        from hyperi_pylib.kafka.client import KafkaClient, TopicNotFoundError
...
class TestKafkaConsumerPoll:
    ...
    def test_consumer_poll_fatal_error_raises(self, mock_consumer):
        ...
        from hyperi_pylib.kafka.consumer import KafkaConsumer, KafkaConsumerError
...
class TestReservoirSample:
    ...
    def test_reservoir_sample_returns_k_messages(self):
        ...
        from hyperi_pylib.kafka.sampling import reservoir_sample
        from hyperi_pylib.kafka.types import Message
...
class TestTimeBoundedConsume:
    ...
    def test_time_bounded_consume_respects_limit(self, mock_consumer):
        ...
        from hyperi_pylib.kafka.consumer import KafkaConsumer
        from hyperi_pylib.kafka.sampling import time_bounded_consume
...
class TestPartitionSample:
    ...
    def test_partition_sample_returns_dict(self):
        ...
        from hyperi_pylib.kafka.sampling import partition_sample
        from hyperi_pylib.kafka.types import Message
...
class TestSchemaAnalyser:
    ...
    def test_analyser_init(self):
        ...
        from hyperi_pylib.kafka.schema import SchemaAnalyser
...
def mock_async_admin_client():
    ...
    with patch("hyperi_pylib.kafka.async_client.AdminClient") as mock:
        yield mock
...
def mock_async_consumer():
    ...
    with patch("hyperi_pylib.kafka.async_consumer.Consumer") as mock:
        yield mock
...
def mock_async_producer():
    ...
    with patch("hyperi_pylib.kafka.async_producer.Producer") as mock:
        yield mock
...
class TestKafkaModuleExports:
    ...
    def test_import_sampling_functions(self):
        """Sampling functions should be importable from hyperi_pylib.kafka."""
        from hyperi_pylib.kafka import (
            partition_sample,
            reservoir_sample,
    ...
    def test_import_schema_analyser(self):
        """SchemaAnalyser should be importable from hyperi_pylib.kafka."""
        from hyperi_pylib.kafka import SchemaAnalyser

        assert SchemaAnalyser is not None

    def test_import_types(self):
        """Types should be importable from hyperi_pylib.kafka."""
        from hyperi_pylib.kafka import (
            ConsumerGroupInfo,
            Message,
            PartitionInfo,
    ...
    def test_import_defaults(self):
        """Defaults should be importable from hyperi_pylib.kafka."""
        from hyperi_pylib.kafka import (
            ADMIN_DEFAULTS,
            CONSUMER_DEFAULTS,
            PRODUCER_DEFAULTS,
    ...
    def test_import_config_utilities(self):
        """Config utilities should be importable from hyperi_pylib.kafka."""
        from hyperi_pylib.kafka import config_from_env, merge_config

        assert merge_config is not None
        assert config_from_env is not None

    def test_import_exceptions(self):
        """Exceptions should be importable from hyperi_pylib.kafka."""
        from hyperi_pylib.kafka import (
            KafkaConsumerError,
            TopicNotFoundError,
        )
...
class TestKafkaMetricsCollector:
    ...
    def test_metrics_collector_init(self):
        ...
        from hyperi_pylib.kafka.metrics import KafkaMetricsCollector
...
def mock_readonly_admin_client():
    ...
    with patch("hyperi_pylib.kafka.readonly.AdminClient") as mock:
        yield mock
...
def mock_readonly_consumer():
    ...
    with patch("hyperi_pylib.kafka.readonly.Consumer") as mock:
        yield mock
...
class TestConfigFromFile:
    ...
    def test_config_from_properties_file(self, tmp_path):
        ...
        from hyperi_pylib.kafka.config import config_from_file
...
class TestConfigModuleExports:
    ...
    def test_config_from_file_exported(self):
        """config_from_file should be importable from hyperi_pylib.kafka."""
        from hyperi_pylib.kafka import config_from_file
...
class TestKafkaAdmin:
    ...
    def mock_admin_client_for_admin(self):
        ...
        with patch("hyperi_pylib.kafka.admin.AdminClient") as mock:
            yield mock
...
class TestKafkaAdminExports:
    ...
    def test_kafka_admin_exported(self):
        """KafkaAdmin should be importable from hyperi_pylib.kafka."""
...
class TestKafkaAdminOffsetReset:
    ...
    def mock_admin_for_offset(self):
        ...
        with (
            ...
            patch("hyperi_pylib.kafka.admin.Consumer") as mock_consumer,
        ):
...
class TestKafkaConsumerHealth:
    ...
    def test_health_check_no_partitions(self, mock_collector):
        ...
        from hyperi_pylib.kafka.health import HealthIssue, KafkaConsumerHealth
...
class TestHealthIssueEnum:
    ...
    def test_health_issue_values(self):
        ...
        from hyperi_pylib.kafka.health import HealthIssue
...
class TestHealthCheckResult:
    ...
    def test_health_result_creation(self):
        ...
        from hyperi_pylib.kafka.health import HealthCheckResult, HealthIssue
...
class TestKafkaHealthExports:
    ...
    def test_health_classes_exported(self):
        """Health classes should be importable from hyperi_pylib.kafka."""
        from hyperi_pylib.kafka import (
            HealthCheckResult,
            HealthIssue,
            KafkaConsumerHealth,
